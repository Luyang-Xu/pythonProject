...
def stacked_plot(pos_distance, neg_distance, category):
    ...
    # 显示图形
    plt.savefig(path + category + '_testing.pdf')


path = '/Users/luyang/Downloads/'
file = 'spe_service_thresholds.txt'
file =  '0705_test_distance.txt'

(pos_distance, neg_distance) = read_data('', file)


stacked_plot(pos_distance, neg_distance, 'testing')
