...
des_path = '/home/cnic-zyd/seen/dataset/'
des_file = 'vpn_dataset_784.txt'

root, files = get_single_dir_files(feature_path)
for file in files[0]:
    whole_data = generate_labels(feature_path, file)
    print('SUCCESS:' + file)
